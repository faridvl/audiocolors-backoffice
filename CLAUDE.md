...
2. **Colores por token.** `bg-brand`, `text-navy-700`. Nunca hex arbitrario (`bg-[#f97316]`) — es el error que dejó a Zynka con dos paletas rivales.
...
8. **Texto por `<Typography>`**, no `<p>`/`<span>`/`<h*>` sueltos con copy.
