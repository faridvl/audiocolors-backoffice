...
/** Mismo patron que ConfirmDeleteModal de documentos, con el texto propio de un contacto. */
export const ConfirmDeleteContactModal: React.FC<ConfirmDeleteContactModalProps> = ({
  contactName,
  isDeleting,
  onConfirm,
  onCancel,
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <Typography variant={TypographyVariant.ACCENT}>Eliminar teléfono</Typography>
            <Typography variant={TypographyVariant.BODY} className="mt-1">
              Se eliminará el teléfono de{' '}
              <span className="font-medium text-ink-800">{contactName}</span> de forma permanente.
